			...
			if(isset($_POST['login']))
			{
				...
				if($_SERVER["REQUEST_METHOD"] == "POST")
				{
					...
					if (isset($row['Username']) == $username && isset($row['Password']) == $password) {
						header("location: http://localhost:3000/Web-Development-Project-master/home.php");
		...
		if(isset($_POST['signup']))
		{
			...
			if ($password1 != $password2)
			...
			else if($password1 == $password2)
				{
					...
					header('localhost: C:\Users\DELL\Desktop\Web-Development-Project-master\Web-Development-Project-master\login.php');
					echo "Data Stored" ;
				}
				mysqli_close($link);
			}
